...
const DICT = {
  en: {
    ...
    "phone.open": "Open Strava in the browser",
    "phone.s1": "Log in. Use the browser, not the Strava app.",
    "phone.s2": "Open the activity (menu → <b>My Activities</b>) and copy the address from the address bar.",
    ...
    "link.share": "That’s a share link from the Strava app. Open Strava in the browser (button above), open the activity there and copy the address from the address bar.",
  ...
  cs: {
    ...
    "phone.open": "Otevřít Stravu v prohlížeči",
    "phone.s1": "Přihlaste se – v prohlížeči, ne v aplikaci Strava.",
    "phone.s2": "Otevřete aktivitu (menu → <b>Moje aktivity</b>) a zkopírujte adresu z adresního řádku.",
    ...
    "link.share": "Tohle je odkaz pro sdílení z aplikace Strava. Otevřete Stravu v prohlížeči (tlačítko výše), tam otevřete aktivitu a zkopírujte adresu z adresního řádku.",
